        ...
        for (Player player : ServerTime.factoryServer.getPlayers()) {
            if (player.hasTag("ffa_kits")) {
                ...
                if(attacker != null) {
                    ...
                    if (new ItemStack(handItem).getDisplayName().getString().contains("sword")) {
                        symbol = "\uD83D\uDDE1";
                    } else if (handItem == Items.TRIDENT) {
                        symbol = "\uD83D\uDD31";
                    } else if (new ItemStack(handItem).getDisplayName().getString().contains("axe")) {
                        symbol = "\uD83E\uDE93";
                    }
