        ...
        dispatcher.register(CommandUtils.literal(string)
                ...
                .then(CommandUtils.argument("player", EntityArgument.player())
                        .executes(context -> {
                            ...
                            CustomDuelGUI.openDuelGui(player.unwrap(), context.getArgument("player", ServerPlayer.class));
                            return 1;
                        })
                        .then(CommandUtils.argument("kit", StringArgumentType.string())
                                ...
                                .executes(context -> CustomDuelCommand.challenge(context, context.getArgument("player", ServerPlayer.class), StringArgumentType.getString(context, "kit"), null))
                                .then(CommandUtils.argument("map", StringArgumentType.string())
                                        ...
                                        .executes(context -> CustomDuelCommand.challenge(context, context.getArgument("player", ServerPlayer.class), StringArgumentType.getString(context, "kit"), StringArgumentType.getString(context, "map")))
                                ))));
    }
