...
public class DuelGameMode {
    ...
    public static String[] duels = { "AXE", "SWORD_ONLY", "SHIELD", "POT", "NETH_POT", "OG_VANILLA", "SMP",
            "TRIDENT_ONLY", "HOE_ONLY", "FFA", "BOW_ONLY", "UHC", "VANILLA", "UHC_SHIELD" };
    ...
    public static final DuelGameMode SHIELD = new DuelGameMode("shield", false, GameType.SURVIVAL);

    public static ArrayList<ServerPlayer> NETH_POT_QUEUE = new ArrayList<>();
    public static final DuelGameMode NETH_POT = new DuelGameMode("neth_pot", true, GameType.SURVIVAL);

    public static ArrayList<ServerPlayer> POT_QUEUE = new ArrayList<>();
    public static final DuelGameMode POT = new DuelGameMode("neth_pot", true, GameType.SURVIVAL);
