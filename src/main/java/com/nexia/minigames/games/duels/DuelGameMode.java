...
public class DuelGameMode {
    ...
    public static final DuelGameMode SHIELD = new DuelGameMode("shield", false, true, GameType.ADVENTURE, new ItemStack(Items.SHIELD), false);
    public static final DuelGameMode UHC_SHIELD = new DuelGameMode("uhc_shield", false, true, GameType.SURVIVAL, new ItemStack(Items.GOLDEN_APPLE), false);
    public static final DuelGameMode UHC = new DuelGameMode("uhc", false, true, GameType.SURVIVAL, new ItemStack(Items.LAVA_BUCKET), false);

    public static final DuelGameMode POT = new DuelGameMode("pot", true, true, GameType.ADVENTURE, new ItemStack(Items.SPLASH_POTION), false);
    public static final DuelGameMode NETH_POT = new DuelGameMode("neth_pot", true, true, GameType.ADVENTURE, new ItemStack(Items.NETHERITE_SWORD), true);

    public static final DuelGameMode OG_VANILLA = new DuelGameMode("og_vanilla", true, true, GameType.SURVIVAL, new ItemStack(Items.DIAMOND_CHESTPLATE), true);
    public static final DuelGameMode NETH_SMP = new DuelGameMode("neth_smp", true, true, GameType.SURVIVAL, new ItemStack(Items.NETHERITE_CHESTPLATE), true);
    public static final DuelGameMode CART = new DuelGameMode("cart", true, true, GameType.SURVIVAL, new ItemStack(Items.TNT_MINECART), false);

    public static final DuelGameMode DIAMOND_CRYSTAL = new DuelGameMode("diamond_crystal", true, true, GameType.SURVIVAL, new ItemStack(Items.END_CRYSTAL), false);
