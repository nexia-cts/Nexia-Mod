...
public class GamemodeHandler {
    ...
    public static void spectatePlayer(@NotNull NexiaPlayer executor, @NotNull NexiaPlayer player) {
        ...
        DuelsPlayerData executorData = (DuelsPlayerData) PlayerDataManager.getDataManager(DuelGameHandler.DUELS_DATA_MANAGER).get(executor);
    ...
    public static void unspectatePlayer(@NotNull NexiaPlayer executor, @Nullable NexiaPlayer player, boolean teleport) {
        ...
        if (player != null && player.unwrap() != null) {
            playerData = (DuelsPlayerData) PlayerDataManager.getDataManager(DuelGameHandler.DUELS_DATA_MANAGER).get(player);
        }
    ...
    public static void customChallengePlayer(NexiaPlayer executor, NexiaPlayer player, String customKit, @Nullable DuelsMap selectedmap) {
        ...
        if(customKit.equalsIgnoreCase("vanilla") || customKit.equalsIgnoreCase("smp")) ((DuelsPlayerData)PlayerDataManager.getDataManager(DuelGameHandler.DUELS_DATA_MANAGER).get(executor)).inviteOptions.inviteKit2 = customKit;
