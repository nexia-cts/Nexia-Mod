...
public class DuelsMap {
    ...
    public static final DuelsMap BIGROOM = new DuelsMap("bigroom", false, new ItemStack(Items.OAK_PLANKS), new EntityPos(55, 80, 0, 90, 0), new EntityPos(-55, 80, 0, -90, 0), new StructureMap(new Identifier("duels", "bigroom"), Rotation.NO_ROTATION, true, new BlockPos(0, 80, 0), new BlockPos(-62, -7, -23), true));
