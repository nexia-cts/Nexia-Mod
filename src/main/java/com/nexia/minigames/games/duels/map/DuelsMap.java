...
public class DuelsMap {
    ...
    public static final DuelsMap CASTLE = new DuelsMap("castle", false, new ItemStack(Items.CRACKED_STONE_BRICKS), new EntityPos(0, 220, 25, -180, 0), new EntityPos(0, 220, -25, 0, 0), new StructureMap(new Identifier("duels", "castle"), Rotation.NO_ROTATION, true, new BlockPos(0, 216, 0), new BlockPos(-11, -4, -30), true));
